...
for column in col_list:
    copy_full_training = full_training[:]
    copy_col_list = col_list[:]
    ...
    train_X, test_X, train_y, test_y = train_test_split(copy_full_training, outcomes, test_size = 0.3, random_state = 42)
    ...
    cprint(accuracy_score(predictions, test_y), 'green', attrs = ['bold'])
